...
-(void) registerSections {
    ...
    [[WKApp shared] setMethod:@"channelsetting.groupforbidden" handler:^id _Nullable(id  _Nonnull param) {
        WKChannel *channel = param[@"channel"];
        BOOL isCreatorOrManager = [param[@"is_creator_or_manager"] boolValue];
    ...
    } category:WKPOINT_CATEGORY_CHANNELSETTING sort:89250];
