...
class TSApplication : MultiDexApplication() {
    private val defaultApiBaseUrl = "https://api.meetme.im"
    ...
    private fun initApi() {
        WKSharedPreferencesUtil.getInstance().putSP("api_base_url", defaultApiBaseUrl)
        WKApiConfig.initBaseURLIncludeIP(defaultApiBaseUrl)
    }
