...
// 群活跃排行
export function groupActivityRankGet(params: any) {
  return request({
    url: '/manager/group/activity_rank',
    method: 'get',
    params
  });
}
...
// 设置管理员
export function groupManagersPost(data: any, groupNo: string) {
  return request({
    url: `/manager/groups/${groupNo}/managers`,
    method: 'post',
    data
  });
}
...
// 取消管理员
export function groupManagersDelete(data: any, groupNo: string) {
  return request({
    url: `/manager/groups/${groupNo}/managers`,
    method: 'delete',
    data
