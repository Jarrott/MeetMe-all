      ...
      <div class="h-50px pl-12px pr-12px box-border flex items-center justify-between bd-title">
        ...
        <div class="flex items-center h-50px">
          <el-form inline>
            ...
            <el-form-item class="mb-0 !mr-16px">
              <el-switch v-model="activityRank" active-text="活跃排行" inactive-text="普通列表" @change="onActivityRankChange" />
            </el-form-item>
...
// API 接口
import { groupListGet, groupActivityRankGet, groupForbiddenPut, groupLiftbanPut } from '@/api/group';
...
const column = reactive<Column.ColumnOptions[]>([
  ...
  },
  {
    ...
    width: 110,
    formatter(row: any) {
      return Number(row.message_count || 0).toLocaleString();
    }
  },
  {
...
const getTableList = () => {
  ...
  const request = activityRank.value ? groupActivityRankGet : groupListGet;
  request(queryFrom).then((res: any) => {
