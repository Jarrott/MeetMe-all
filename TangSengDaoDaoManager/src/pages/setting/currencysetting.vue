        ...
        <div class="h-full overflow-auto">
          <div class="w-540px">
            <el-form :model="formData" label-width="160px">
              ...
              <el-form-item label="自动翻译对话：">
                <el-radio-group v-model="formData.auto_translate_on">
                  <el-radio :label="1">开启</el-radio>
                  <el-radio :label="0">关闭</el-radio>
                </el-radio-group>
              </el-form-item>
              <el-form-item label="会话分组管理：">
                <el-radio-group v-model="formData.conversation_team_enabled">
                  <el-radio :label="1">开启</el-radio>
                  <el-radio :label="0">关闭</el-radio>
                </el-radio-group>
              </el-form-item>
              <el-form-item label="群成员直接私聊：">
                <el-radio-group v-model="formData.group_member_private_chat_enabled">
...
const formData = reactive({
  ...
  auto_translate_on: 0,
  conversation_team_enabled: 1,
  group_member_private_chat_enabled: 1
});
//  初始化数据
const initData = () => {
  getAppconfigGet().then((res: any) => {
    ...
    formData.auto_translate_on = res.auto_translate_on || 0;
    formData.conversation_team_enabled = res.conversation_team_enabled ?? 1;
    formData.group_member_private_chat_enabled = res.group_member_private_chat_enabled ?? 1;
  });
};
