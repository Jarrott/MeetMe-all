...
type IService interface {
	...
	// 是否有共同群聊
	ExistCommonGroupMember(uid string, toUID string) (bool, error)
...
func (s *Service) ExistCommonGroupMember(uid string, toUID string) (bool, error) {
	return s.db.existCommonGroupMember(uid, toUID)
}
