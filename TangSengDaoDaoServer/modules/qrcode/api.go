...
func (q *QRCode) handleQRCodeInfo(c *wkhttp.Context) {
	...
	case common.QRCodeType("walletReceive"): // 钱包收款码
		result = NewHandleResult(ForwardNative, HandlerType("walletReceive"), map[string]interface{}{
			"code":         code,
			"receiver_uid": qrCodeModel.Data["receiver_uid"],
			"amount":       qrCodeModel.Data["amount"],
			"remark":       qrCodeModel.Data["remark"],
		})
	default:
