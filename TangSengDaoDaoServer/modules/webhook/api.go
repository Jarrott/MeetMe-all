...
func getSupportTypes() []common.ContentType {
	return []common.ContentType{common.Text, common.Image, common.ContentType(contentTypeImageGroup), common.GIF, common.Voice, common.Video, common.File, common.Location, common.Card, common.MultipleForward, common.VectorSticker, common.EmojiSticker}
}
